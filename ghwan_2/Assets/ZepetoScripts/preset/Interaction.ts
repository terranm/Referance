    ...
    *CarRideCoroutine() 
    {
        ...
        ZepetoPlayers.instance.LocalPlayer.zepetoPlayer.character.transform.position = this.gameObject.transform.position;
        ZepetoPlayers.instance.LocalPlayer.zepetoPlayer.character.transform.Translate(5,0,0);
