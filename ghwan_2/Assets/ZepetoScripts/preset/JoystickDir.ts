import { GameObject, Mathf, Sprite, Time, Vector2, Vector3, WaitForFixedUpdate, WaitForSeconds } from 'UnityEngine';
...
export default class JoystickDir extends ZepetoScriptBehaviour {
    ...
    public handleIcon_Nor:Sprite;
    public handleIcon_Dri:Sprite;
    
    private isPointerDown:boolean = false;
    //public staticR:GameObject;
    private jumpBtn:GameObject;
    private carStopBtn:GameObject;
    private carStopBtnBtn:Button;
    private multiplay:ZepetoWorldMultiplay;
    private playerCtrl: PlayerCtrl;
    private moveBtnImage: Image;
    private alert:GameObject;
    ...
    Start() {    
        ...
        this.carStopBtnBtn = this.carStopBtn.GetComponentInChildren<Button>();
        this.moveBtnImage = this.transform.parent.GetChild(1).GetChild(2).GetComponent<Image>();
                    ...
                    if(this.playerCtrl != null){
                        this.playerCtrl.event.AddListener((ride:number)=>{
                            if(ride == 0){
                                ...
                                console.log(ZepetoPlayers.instance.LocalPlayer.zepetoPlayer.character.enabled);
                            }
                            else if (ride == 2){
                        ...
                        this.alert.GetComponent<Alert>().event = this.playerCtrl;
