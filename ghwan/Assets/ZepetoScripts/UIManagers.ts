...
export default class UIManagers{
    ...
    public Init() {
        ...
        this.carOffBtn = this.canvasObj.transform.GetChild(10).GetComponent<Button>();
        this.cancleBtn = this.carPopop.transform.GetChild(1).GetComponent<Button>();
        this.okBtn = this.carPopop.transform.GetChild(0).GetComponent<Button>();
