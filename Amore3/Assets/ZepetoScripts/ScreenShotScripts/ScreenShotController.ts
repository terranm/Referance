...
export default class ScreenShotController extends ZepetoScriptBehaviour {
    ...
    public renderTexture2: RenderTexture;
    ...
    public SaveScreenShot() {
        ...
        ZepetoWorldContent.SaveToCameraRoll(this.renderTexture, (result: boolean) => { console.log(`${result}`) });
             ...
             //스크린샷 저장
        ZepetoWorldContent.SaveToCameraRoll(this.renderTexture2, (result: boolean) => { console.log(`${result}`) });
        }
    ...
    public ShareScreenShot() {
        if(this.camera.targetDisplay == 0){
            ...
            ZepetoWorldContent.Share(this.renderTexture2, (result: boolean) => { console.log(`${result}`) });
        }
    ...
    public CreateFeedScreenShot() {
        if(this.camera.targetDisplay == 0){
            ...
            ZepetoWorldContent.CreateFeed(this.renderTexture2, this.feedMessage, (result: boolean) => {
                this.uiController.ShowCreateFeedResult(result);
            });
        }
